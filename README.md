...
| `availability_zones` | Azure Availability Zones to be used.| `list(number)`                            | `[1,2,3]`             | `no`         |
...
| `min_capacity`   | Minimum number of instances the resultant node pool(s) should have.  If single_vmss is set to false, this number must be divisible by the number of Availability Zones.                                                                                                 | `number`                          | `nil`       |
| `max_capacity`   | Maximum number of instances the resultant node pool(s) should have. If single_vmss is set to false, this number must be divisible by the number of Availability Zones.                                                                             | `number`                          | `nil`       |
