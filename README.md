...
| `sku_tier`                                                          | Pricing tier for the Azure Kubernetes Service managed cluster; \"free\" & \"paid\" are supported. For production clusters or clusters with more than 10 nodes this should be set to `paid` (see [docs](https://learn.microsoft.com/en-us/azure/aks/free-standard-pricing-tiers)).                                                                                                                                   | `string`                                   |                   |                                                                                                                                                                                                                                           | `bool`                                     |                   |
