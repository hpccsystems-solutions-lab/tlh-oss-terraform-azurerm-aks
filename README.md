...
| `cluster_version`                                                   | Kubernetes version to use for the Azure Kubernetes Service managed cluster; versions`1.24`([EXPERIMENTAL](#aks-v124)), `1.23` or `1.22` (DEPRECATED) are supported.                                                                                                                                                                                                                                                              | `string`                                     |                   |
