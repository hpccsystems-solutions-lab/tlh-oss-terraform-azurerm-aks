...
| cert\_manager\_dns\_zones | The name and resource group of the DNS zone associated with your Azure subscription | <pre>object({<br>    names = list(string)<br>    resource_group_name = string<br>  })</pre> | n/a | yes |
