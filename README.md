...
| `cluster_version`                                                   | Kubernetes version to use for the Azure Kubernetes Service managed cluster; versions `1.26` (**EXPERIMENTAL**),`1.25`, `1.24` or `1.23` (DEPRECATED) are supported.                                                                                                                                                                                                                                                 | `string`                                   |                   |
