...
- Updated _Cert Manager_ chart to [v1.12.2](https://github.com/cert-manager/cert-manager/releases/tag/v1.12.2). ([#1251](https://github.com/LexisNexis-RBA/rsg-terraform-azurerm-aks/pull/1251)) [@hadeeds](https://github.com/hadeeds)
